    ...
    return (
        <div className="w-full md:w-2/3 lg:w-2/4 m-auto px-4 md:px-0 min-h-[70vh] md:h-[90vh] flex items-center gap-4 md:gap-6 justify-center mx-auto flex-col lg:flex-row pb-8">
            <div className="border-4 border-solid p-1 md:p-1.25 rounded-full border-[lightpink] bg-[#dde1e7] mr-0 lg:mr-2 z-10">
                <Image src={profilePic} alt="profile-pic" width={250} height={250} className="rounded-full bg-amber-500" />
            </div>
            <div className="z-10 flex flex-col gap-3 md:gap-4 items-center lg:items-start text-center lg:text-left">
                ...
                />
                <h2 className="font-bold tracking-[0.03rem] leading-7 md:leading-10 text-3xl text-[#a8adb2] relative max-w-full">
